...
const universitiesService = {
  async loadUniversities(countryCode) {
    try {
      ...
      console.log(`✅ Loaded ${uniqueUniversities.length} universities for ${countryName}`);
  ...
  populateUniversityDropdown(selectId, universities) {
    ...
    console.log(`✅ Populated ${universities.length} universities + "Other" option in ${selectId}`);
  },
